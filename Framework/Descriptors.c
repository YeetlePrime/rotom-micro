/*
Modified code from bertrandom (https://github.com/bertrandom).
Used in the project snowball-thrower (https://github.com/bertrandom/snowball-thrower)
*/

#include "Descriptors.h"

// HID Descriptors.
const USB_Descriptor_HIDReport_Datatype_t PROGMEM ControllerReport[] = {
	HID_RI_USAGE_PAGE(8,1), /* Generic Desktop */
	HID_RI_USAGE(8,5), /* Controller */
	...
	.HID_ControllerHID =
		{
			...
			.HIDReportLength        = sizeof(ControllerReport)
		},
	...
	.HID_ReportINEndpoint =
		{
			...
			.EndpointAddress        = CONTROLLER_IN_EPADDR,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = CONTROLLER_EPSIZE,
	...
	.HID_ReportOUTEndpoint =
		{
			...
			.EndpointAddress        = CONTROLLER_OUT_EPADDR,
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = CONTROLLER_EPSIZE,
			.PollingIntervalMS      = 0x05
		},
...
uint16_t CALLBACK_USB_GetDescriptor(
	...
	switch (DescriptorType)
	{
		...
		case DTYPE_String:
			...
			break;
		case DTYPE_HID:
			Address = &ConfigurationDescriptor.HID_ControllerHID;
			Size    = sizeof(USB_HID_Descriptor_HID_t);
			break;
		case DTYPE_Report:
			Address = &ControllerReport;
			Size    = sizeof(ControllerReport);
			break;
	}
